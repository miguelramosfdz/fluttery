...
`RandomColorBlock` is a `Container` that paints itself with a random color. This way a developer can quickly frame out an user interface with regards to positioning and sizing without worrying about the final `Widget`s.
